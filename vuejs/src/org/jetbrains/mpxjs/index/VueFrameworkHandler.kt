...
import org.jetbrains.mpxjs.libraries.componentDecorator.VueDecoratedComponentInfoProvider
import org.jetbrains.mpxjs.libraries.componentDecorator.isComponentDecorator
import org.jetbrains.mpxjs.model.getSlotTypeFromContext
import org.jetbrains.mpxjs.model.hasSrcReference
import org.jetbrains.mpxjs.model.source.*
import org.jetbrains.mpxjs.model.source.VueComponents.Companion.isStrictComponentDefiningCall
import org.jetbrains.mpxjs.model.tryResolveSrcReference
import org.jetbrains.mpxjs.model.typed.VueTypedEntitiesProvider
import org.jetbrains.mpxjs.types.VueCompositionPropsTypeProvider
...
class VueFrameworkHandler : FrameworkIndexingHandler() {
  ...
  companion object {
    ...
    private val VUE_DESCRIPTOR_OWNERS = arrayOf(VUE_NAMESPACE, MIXIN_FUN, COMPONENT_FUN, EXTEND_FUN, DIRECTIVE_FUN, DELIMITERS_PROP,
                                                FILTER_FUN, DEFINE_COMPONENT_FUN, CREATE_PAGE_FUN, CREATE_APP_FUN, DEFINE_NUXT_COMPONENT_FUN)
  ...
  private fun isComponentDefiningCall(callNode: ASTNode): Boolean =
    checkCallExpression(callNode) { referenceName, hasQualifier ->
      ...
      || (!hasQualifier && referenceName == CREATE_APP_FUN)
