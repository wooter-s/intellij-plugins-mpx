...
abstract class BasicElementDescriptor : XmlElementDescriptor {
    ...
    override fun getElementDescriptor(child: XmlTag, context: XmlTag): XmlElementDescriptor? {
        return XmlElementDescriptorProvider.EP_NAME.findExtension(CustomElementDescriptorProvider::class.java)
                ?.getDescriptor(child)
    }
